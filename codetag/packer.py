...
def _gather_candidates(
    ...
    *,
    ...
    for fp in all_files:
        ...
        # Read file once and skip self-generated outputs.
        try:
            content = fp.read_text(encoding="utf-8", errors="ignore")
        except Exception:
            continue

        if content.startswith(CODETAG_MARKER):
            # Ignore files CodeTag produced in previous runs.
            continue
...
def _format_packed_output(
    ...
    *,
    ...
    if output_format.lower() == "json":
        ...
        raise ValueError(
            f"Invalid output_format: {output_format}. Use 'raw' or 'json'."
        )
...
def pack_repository(
    *,
    ...
    output_format:
        Either ``"raw"`` or ``"json"`` – matches the original CLI semantics.
